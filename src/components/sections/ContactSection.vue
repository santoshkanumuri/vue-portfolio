        ...
        <div class="flex flex-col justify-center text-gray-900 dark:text-white">
            ...
            <div class="space-y-4">
              <div class="flex items-start">
                ...
                <div>
                  ...
                  <a href="mailto:santosh.kanumuri@hotmail.com" class="text-sm sm:text-base text-gray-600 dark:text-gray-300 hover:text-primary transition-colors">santosh.kanumuri@hotmail.com</a>
                </div>
              </div>
          ...
          <div>
            ...
            <div class="flex space-x-4">
              ...
              <a href="mailto:santosh.kanumuri@hotmail.com" class="h-12 w-12 rounded-full bg-primary flex items-center justify-center text-white hover:bg-accent transition-colors">
